...
import { CompleteContractCreate } from "@/schemas/contract.schema"

export default function ReviewStep() {
  const form = useFormContext<CompleteContractCreate>()
  const data = form.getValues()
  return (
    <div className="space-y-8">
      {/* Basic Info Section */}
      <div>
        <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Informasi Dasar</h3>
      ...
      {/* Personnel Section */}
      <div>
        <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Personel</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
      ...
      {/* Financial Section */}
      <div>
        <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Keuangan</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
      ...
      <div>
        <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Detail Kontrak</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
          ...
          <div>
            ...
            <p className="text-sm sm:text-base">{data.tanggalKontrak ? format(data.tanggalKontrak, "dd MMMM yyyy") : "-"}</p>
          </div>
          <div>
      ...
      {/* Supervision Section */}
      <div>
        <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Supervisi</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
          ...
          <div>
            ...
            <p className="text-sm sm:text-base">{data.tanggalKontrakSupervisi ? format(data.tanggalKontrakSupervisi, "dd MMMM yyyy") : "-"}</p>
          </div>
          <div>
      ...
      <div>
        <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Detail Tambahan</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
      ...
      <div>
        <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Dokumentasi</h3>
      ...
      {/* Location Section */}
      <div>
        <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Lokasi</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
      ...
      <div>
        <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Progress Keuangan</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
      ...
      <div>
        <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Progress Fisik</h3>
      ...
      {/* Addendum Section - Conditionally rendered */}
      {data.hasAddendum && data.addendum && data.addendum.length > 0 && (
        <div>
          <h3 className="text-lg font-semibold mb-3 pb-2 border-b">Addendum</h3>
          <div className="space-y-4">
